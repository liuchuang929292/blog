...
<?php
    ...
    <li><span style="float:right;padding-right:15px;"><?php the_time('m-d') ?></span><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php echo ATheme_cut_str($post->post_title,40); ?></a> <small>(<?php if(function_exists(the_views)) { the_views(' 次', true);}?>)</small></li>
	<?php
