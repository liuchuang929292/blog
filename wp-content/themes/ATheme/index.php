    ...
    <div id="content">
        <?php if (have_posts()) : ?>
            ...
            <div class="excerpt">
                ...
                <h2><a href="<?php the_permalink() ?>" rel="external" title="详细阅读 <?php the_title_attribute(); ?>"><?php echo '<img src="'.get_bloginfo('template_directory').'/images/sticky.gif" alt="" /> <span style="color:red;">[置顶]</span> ';the_title(); ?></a></h2>
                </div>
                <?php else : ?>
