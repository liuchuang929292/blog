...
<?php if ($comments) : ?>
	...
	<?php wp_list_comments('type=comment&callback=ATheme_comment&end-callback=ATheme_end_comment&max_depth=23'); ?>
	</ol>
...
<?php
	...
	if($current_user->user_level >1){
		echo "<img src='", bloginfo('template_directory') ,"/images/vip_mark.png' title='博主认证'  alt='（博主认证）' style='width:16px; height:16px; margin-bottom:-2px;display:inline;' />，";
	}else{
		echo '，';
	}
?>
&nbsp;&nbsp;<a href="<?php echo wp_logout_url(get_permalink()); ?>" title="退出账户"><?php print '[ 退出账户 ]'; ?></a>
	...
	<div id="comment-author-info">
		<p>
			...
			<label for="email">邮箱<span id="Get_Gravatar"></span></label>
			<input type="text" name="email" id="email" class="commenttext" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" /><?php if ($req) echo " *"; ?>
